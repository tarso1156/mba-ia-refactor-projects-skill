...
6. **Salvar relatório** — volte uma pasta e crie o diretório `reports/` na pasta pai do projeto (se não existir) e salve o relatório como `reports/audit-report-3.md` (sobreescreva o arquivo, caso já exista), O relatório salvo deve ser idêntico ao apresentado ao usuário, salve mesmo sem, encontrar algum problema.
